...
describe("PolygonZkEVMEtrog", () => {
    ...
    beforeEach("Deploy contract", async () => {
        ...
        const PolygonZKEVMV2Factory = await ethers.getContractFactory("PolygonZkEVMEtrogIsolated");
    ...
    it("should check full flow", async () => {
        ...
        const maticAmount = (await rollupManagerContract.getBatchFee()) * 100n;
        ...
        await rollupManagerContract.setAcceptSequenceBatches(false);

        const l1infoRoot = await polygonZkEVMGlobalExitRoot.getRoot();
        let currentBatchSequenced = 1;
        await expect(
            ...
            .withArgs(++currentBatchSequenced, l1infoRoot);
        ...
        await rollupManagerContract.setAcceptSequenceBatches(true);
