...
async function main() {
    ...
    // Upgrade AgglayerBridge -> AgglayerBridgeL2NativeBlockedFromEtrog
    const newBridgeFactory = await ethers.getContractFactory('AgglayerBridgeL2NativeBlockedFromEtrog', deployer);
