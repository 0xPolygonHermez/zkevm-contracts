...
Script to create schedule and execute transaction for upgrading BridgeL2SovereignChain
...
```
cp ./upgrade/upgradeSovereignV2/upgrade_parameters.json.example ./upgrade/upgradeSovereignV2/upgrade_parameters.json
```
...
- Fill configuration file:
    ...
    - "forkParams": -> Optional: Parameters needed to do shallow fork test
      ...
      - "timelockAdminAddress": "0x..", -> Optional: The address of the timelock admin
