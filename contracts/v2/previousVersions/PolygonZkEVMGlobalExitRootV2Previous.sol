...
import "./lib/PolygonZkEVMGlobalExitRootBaseStoragePrevious.sol";
 ...
 */
contract PolygonZkEVMGlobalExitRootV2Previous is
    PolygonZkEVMGlobalExitRootBaseStoragePrevious,
    DepositContractBase
{
    ...
    function getRoot()
        public
        view
        override(DepositContractBase, IPolygonZkEVMGlobalExitRootV2Previous)
        returns (bytes32)
    {
