    ...
    IPolygonZkEVMBridgeV2
{
    ...
    // Init code of the erc20 wrapped token
    bytes private constant _BASE_INIT_BYTCODE_WRAPPED_TOKEN =
    ...
    function initialize(
        ...
        if (_gasTokenAddress == address(0)) {
            ...
            TokenWrapped newWrappedToken;
            bytes memory initBytecode = abi.encodePacked(
                _BASE_INIT_BYTCODE_WRAPPED_TOKEN,
