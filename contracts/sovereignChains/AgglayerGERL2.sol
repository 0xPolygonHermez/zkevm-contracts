    ...
    IVersion
{
    ...
    //     uint256[] calldata globalIndexes, // sanity check networkID == globalIndex.networkID
    //     bytes32 calldata localExitRoot,
    ...
    //         smtProofLocalExitRoots.length != localExitRoots.length ||
    ...
    //         smtProofLocalExitRoots.length != originNetworksLERs.length
    //     ) {
    //         revert InputArraysLengthMismatch();
    //     }
    //     insertLERs(localExitRoots, networkID);
