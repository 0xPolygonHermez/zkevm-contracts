# ClaimCompressor
[Git Source](https://github.com/agglayer/agglayer-contracts/blob/c0e111af46ac2964bd5177034698d7e5e691f362/contracts/periphery/ClaimCompressor.sol)
...
```solidity
bytes4 private constant _CLAIM_ASSET_SIGNATURE = AgglayerBridge.claimAsset.selector
```
...
```solidity
bytes4 private constant _CLAIM_MESSAGE_SIGNATURE = AgglayerBridge.claimMessage.selector
```
