...
async function main() {
    ...
    const { timelockAddress } = mainnetDeployParameters; // not relevant to deployed bytecode
    const { minDelayTimelock } = mainnetDeployParameters; // not relevant to deployed bytecode
